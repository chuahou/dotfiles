...
alias p="git push --recurse-submodules=check"
alias pom="git push origin master --recurse-submodules=check"
alias pomf="git push origin master -f --recurse-submodules=check"
alias pomu="git push origin master -u --recurse-submodules=check"
alias pall="git push origin --all --tags --recurse-submodules=check"
alias pull="git pull"
